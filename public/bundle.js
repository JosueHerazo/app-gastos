...
const cargarGastos = () => {
    ...
    if(gastos && gastos.length > 0){
        ...
        // la clase que muestra el mensaje de sin registro lo eliminamos al el carrito llenarse con el otro codigo
       ...
       contenedorGastos$1.innerHTML += `
        ...
        <div class="gasto__info">
            ...
            <p class="gasto__fecha">${format(parseISO(gasto.fecha),"d   MMMM yyyy", {locale: es})}</p>
        </div>
